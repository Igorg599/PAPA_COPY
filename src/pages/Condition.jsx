    ...
    return (
        <div className="about">
            <div className="container">
                ...
                <div className="about__des">Минимальная сумма заказа 500 - 700 рублей(см. карту доставок).</div>
                <div className="about__des">В пределах представленной карты доставка бесплатная (в зависимости от удалённости и минимальной суммы заказа.</div>
                <div className="about__des">Сделать заказ можно в вс-чт с 11-00 до 23-00 и в пт-сб с 11-00 до 01-00 по телефону 231-88-84 и на сайте papapizza59.ru</div>
                <div className="about__des">Время доставки от 60 до 120 минут (зависит от удалённости и дорожной ситуации).</div>
